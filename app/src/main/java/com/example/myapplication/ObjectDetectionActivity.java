...
public class ObjectDetectionActivity extends CameraActivity_pray {
    ...
    private static final String MODEL_FILE = "ssd_v2_praying20210206.tflite";
...
//                    }
                ...
                () -> {
                    ...
                    new CountDownTimer(10000, 1000) {
                        ...
                        public void onFinish() {
                            Log.d("time","Time is: "+ currTimestamp);
                            praying(lastProcessingTimeMs);
                        }
                    }.start();
                });
    ...
    private void praying(long processTime) {
        if (processTime >= 5L) {
            Log.d("PTime","processTime: "+processTime);
            Intent i = new Intent(ObjectDetectionActivity.this, PrayingWaitActivity.class);
            startActivity(i);
        } else {
            Intent i = new Intent(ObjectDetectionActivity.this, PrayingWaitActivity.class);
            startActivity(i);
